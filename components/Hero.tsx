...
const headline = ["Ship", "the", "right", "thing."];
  ...
  return (
    <section className="px-6 md:px-12 pt-32 md:pt-44 pb-16 md:pb-24">
      ...
      <motion.p
        ...
        className="text-base tracking-widest uppercase text-black/40 mb-10"
      >
      ...
      >
        <p className="text-base md:text-2xl text-black/80 font-regular max-w-2xl leading-relaxed">
          I turn ambiguous problems into clear priorities, aligned teams, and products that actually ship.
        </p>
      </motion.div>
    </section>
  );
